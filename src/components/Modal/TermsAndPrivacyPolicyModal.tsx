...
const TermsAndPrivacyPolicyModal = ({ onConfirm, open, setOpen }: Props) => {
  const modalContentRef = useCallback((node: HTMLElement | null) => {
  ...
  return (
    <Modal
      title="HIPSTR TERMS OF SERVICE & PRIVACY POLICY"
      onConfirm={onConfirm}
      acceptText="I Agree"
      cancelText="Close"
      open={open}
      ...
      size="lg"
    >
      <div className="tw-max-h-[500px] tw-overflow-auto tw-text-start" ref={modalContentRef}>
        <div>
          <h2 className="tw-uppercase">TERMS OF SERVICE</h2>
          <p>Last updated: November 08, 2023</p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                Agreement) refers to Hipstr, 244 5th Ave, M-292 New York.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                use of the Service. This Terms and Conditions agreement has been created with the
                help of the{" "}
                <a
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Hipstr, accessible from{" "}
                <a href="https://bookhipstr.com/" rel="external nofollow noopener" target="_blank">
                  bookhipstr.com/
                </a>
              </p>
            </li>
          ...
          <ul>
            <li>By email: info@bookhipstr.com</li>
          </ul>
        </div>
        <div>
          <h2 className="tw-uppercase">Privacy Policy</h2>
          <p>Last updated: November 08, 2023</p>
          <p>
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Company</strong> (referred to as either the Company, We, Us or Our in this
                Agreement) refers to Hipstr, Juan Paullier 1218.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Country</strong> refers to: Uruguay
              </p>
            </li>
            <li>
              <p>
