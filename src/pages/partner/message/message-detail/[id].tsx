...
import SidebarLeft from "@components/Message/SidebarLeftPartner";
import SidebarRight from "@components/Message/SidebarRightPartner";
...
const MessageDetails: NextPageWithLayout = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Hipstr - Messages-details</title>
      </Helmet>
